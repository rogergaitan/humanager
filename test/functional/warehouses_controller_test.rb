...
class WarehousesControllerTest < ActionController::TestCase
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post :create, warehouse: { address: @warehouse.address, code: @warehouse.code, description: @warehouse.description, manager: @warehouse.manager, name: @warehouse.name }
    end
  ...
  test "should update warehouse" do
    put :update, id: @warehouse, warehouse: { address: @warehouse.address, code: @warehouse.code, description: @warehouse.description, manager: @warehouse.manager, name: @warehouse.name }
    assert_redirected_to warehouse_path(assigns(:warehouse))
  end
