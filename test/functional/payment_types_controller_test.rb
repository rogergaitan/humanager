...
class PaymentTypesControllerTest < ActionController::TestCase
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post :create, payment_type: { description: @payment_type.description, factor: @payment_type.factor, name: @payment_type.name }
    end
  ...
  test "should update payment_type" do
    put :update, id: @payment_type, payment_type: { description: @payment_type.description, factor: @payment_type.factor, name: @payment_type.name }
    assert_redirected_to payment_type_path(assigns(:payment_type))
  end
