class PaymentOptionsController < ApplicationController
  ...
  def index
    ...
    @payment_options = PaymentOption.paginate(:page => params[:page])
  ...
  def create
    ...
    respond_to do |format|
      if @payment_option.save
        format.html { redirect_to payment_options_path, notice: t('.activerecord.models.payment_option').capitalize + t('.notice.successfully_created') }
  ...
  def update
    ...
    respond_to do |format|
      if @payment_option.update_attributes(params[:payment_option])
        format.html { redirect_to payment_options_path, notice: t('.activerecord.models.payment_option').capitalize + t('.notice.successfully_updated') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to payment_options_url, notice: t('.activerecord.models.payment_option').capitalize + t('.notice.successfully_deleted') }
      format.json { head :no_content }
    end
  end
end
