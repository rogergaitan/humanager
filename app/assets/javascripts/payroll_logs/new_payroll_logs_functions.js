...
pl.getTemporalData = function() {
  ...
  tmpData.wage_payment = $(pl.current_employee).find('#wage_payment').val();
  // CC
...
pl.setSubTotalByRow = function(tmpData) {
  var cost = tmpData.wage_payment || tmpData.task.cost;
...
pl.addNewColumn = function(employee_id, wage_payment, payment_unit, data) {
  ...
  filterData.push(cost); // Task - Cost
  filterData.push(nunidad); // Task - Unit
