  ...
  this.provinceSelected = function(canton_id) {
   ...
   $(cantons).each(function() {
     if(this[0] == province_id) {
       if(canton_id == this[2]) {
         attrSelected = true;
         $('#employee_entity_attributes_addresses_attributes_0_canton_id')
	   .append("<option selected='selected' value='" + this[2] + "'>" + this[1] + "</option>");
       } else {
         $('#employee_entity_attributes_addresses_attributes_0_canton_id')
          .append("<option value='" + this[2] + "'>" + this[1] + "</option>");
       }
     }
   });
...
this.cantonSelected = function(district_id) {
  ...
  $('#employee_entity_attributes_addresses_attributes_0_district_id').find('option').remove();
    $(district).each(function() {
	   ...
	   attrSelected = true;
	   $('#employee_entity_attributes_addresses_attributes_0_district_id')
	     .append("<option selected='selected' value='" + this[2] + "'>" + this[1] + "</option>");
	 } else {
	   $('#employee_entity_attributes_addresses_attributes_0_district_id')
	      .append("<option value='" + this[2] + "'>" + this[1] + "</option>");
